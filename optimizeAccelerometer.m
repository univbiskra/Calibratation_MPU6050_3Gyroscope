function [RMSE] = optimizeAccelerometer(x, n, ACC, G)
...
[ACC_est] = ApplyCorrection(ACC, n, T, S, b);           % Correction of accelerations using SEM estimated using fminunc function 
[RMSE, delta] = calculateRMSE(ACC_est, n, G);               % Computation of RMSE
